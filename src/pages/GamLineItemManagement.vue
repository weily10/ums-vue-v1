        ...
        <div class="bg-grey mt-3  p-3">
            <div class="mb-2 d-flex flex-column">
                <div class="d-flex align-items-end gap-2 flex-wrap border-bottom pb-3">
                            ...
                            <div class="col flex-fill">
                                <div class="input-group mt-1">
                                    <input type="text" class="form-control border-end-0" placeholder="結束日期"
                                        id="gam-line-item-performance-end-date-btn">
                    ...
                    <div class="col">
                        <label class="font-b4-me"> 委刊項的代號 </label>
                        <div class="input-group mt-1" id="adv-management-gam-error-count-query">
                            <input type="number" maxlength="10" min="0" class="form-control"
                                id="adv-management-line-item-code" placeholder="委刊項代號">
                        </div>
                    </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-start align-text-top">委刊項ID
                            </th>
                            <th scope="col" class="text-start align-text-center">原始檔名
                            </th>
                            <th scope="col" class="text-start align-text-top">委刊項名稱
                            </th>
                            <th scope="col" class="text-center align-text-top">大主題
                            </th>
                            <th scope="col" class="text-start align-text-top"> 小主題
                            </th>
                            <th scope="col" class="text-start align-text-top">使用者異動時間(員編)
                            </th>
